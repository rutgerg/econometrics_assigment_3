...
ADL(3,1) model and testing for joint relevance
```{r echo=FALSE}
aq1d  <- lm(ret ~ ret_1 + ret_2 + ret_3 + TSpr, data=MyQ1Data)
linearHypothesis(aq1d, c("ret_1=0","ret_2=0","ret_3=0","TSpr=0"), vcov. = sandwich)
```

Conclusion: p-value is small so we do not reject H0. Hence the variables have predictive power.
