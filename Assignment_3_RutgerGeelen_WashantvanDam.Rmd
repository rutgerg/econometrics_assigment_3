...
ADL(3,1) model and testing for joint predictiveness.
```{r echo=FALSE}
aq1d  <- lm(ret ~ ret_1 + ret_2 + ret_3 + TSpr, data=MyQ1Data)
linearHypothesis(aq1d, c("ret_1=0","ret_2=0","ret_3=0","TSpr=0"), vcov = vcovHC(aq1d,"HC1"))
```
...
```{r echo=FALSE}
aq1e  <- lm(ret ~ ret_1 + ret_2 + ret_3 + TSpr, data=MyQ1Data)
linearHypothesis(aq1e, c("ret_1=0","ret_2=0","ret_3=0","TSpr=0"), vcov = vcovHC(aq1e,"HC1"))
```
